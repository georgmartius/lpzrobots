...
namespace lpzrobots {
  ...
  */
  void Skeleton::create( const Matrix& pose ){
    ...
    // Pole1    
 //    b = new Box(4.45,1.99,.15);
//     b->init(odeHandle, 1,osgHandle);
//     b->setPose(osg::Matrix::translate(0, 1.1, -1.3) * pose );
...
//     joints.push_back(fj);
    ...
    servo2 =  new TwoAxisServo(uj, -conf.hipJointLimit,/*TEST*/ 3* conf.hipJointLimit, conf.hipPower,
