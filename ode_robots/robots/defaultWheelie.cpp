 ...
 *   name and revision
 *
 *   Revision 1.1.2.3  2006/06/20 07:18:29  robot3
 *   -added cvs log
...
namespace lpzrobots {
  ...
  DefaultWheelie::DefaultWheelie(const OdeHandle& odeHandle, const OsgHandle& osgHandle,
  ...
  DefaultWheelie::~DefaultWheelie()
  {  
    if(created) destroy();
  }

       
  void DefaultWheelie::place(const osg::Matrix& pose){
  ...
  void DefaultWheelie::mycallback(void *data, dGeomID o1, dGeomID o2)
  {
    DefaultWheelie* me = (DefaultWheelie*) data;
    int i=0;
    int o1_index= -1;
    int o2_index= -1;
   ...
   **/
  bool DefaultWheelie::collisionCallback(void *data, dGeomID o1, dGeomID o2)
  {
  ...
  */
  ...
  Configurable::paramval DefaultWheelie::getParam(const paramkey& key) const{    
  ...
  bool DefaultWheelie::setParam(const paramkey& key, paramval val){    
