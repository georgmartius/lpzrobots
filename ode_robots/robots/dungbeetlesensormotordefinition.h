/*
 * dungbeetlesensormotordefinition.h
 *
...
enum dungbeetleSensorNames{
        ...
        //Foot contact sensors (dungbeetle v1 and v2)
        ...
        // Ultrasonic reflex sensors at front, middle and rear legs (dungbeetlev1)
        R0_us= 33,
        R1_us= 34,
        L0_us= 35,
        L1_us= 36,
        ...
        //photo (light) sensors Left, Middle and Right (dungbeetlev1 and v2)
        L_ps = 59,
        M_ps = 60,
        R_ps = 61,
        ...
        A_cs = 65,  //average motor current measurement (dungbeetlev1 & dungbeetlev2)
        B_cs = 121, //direct from Battery of only for dungbeetlev1
        ...
        // on Foot sensor board, dungbeetlev1 and v2
        R0X_acs= 92,
        R0Y_acs= 93,
        R0Z_acs= 94,
        ...
        // Inclinometer sensors of the dungbeetlev1 and v2 body
