...
// this is the part of the ImpTransform2
  ...
  Hexabot::Hexabot(const OdeHandle& odehandle, const OsgHandle& osgHandle,
  ...
  */
  void Hexabot::create(const osg::Matrix& pose){
    ...
    ***********************************************************************************/
    ...
    trunk.tUpTrans = new ImpTransform2(trunk.tPlate[0], trunk.tPlate[1],
            Matrix::rotate(0., Vec3(0, 0, 1)) *
