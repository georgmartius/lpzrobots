 ...
 *                                                                         *
 *   This version (6) of multiexpert has the following features            *
 *    n agents, competition based on suboptimiality                        *
 *    of predictions. The suboptimality is the difference between the      *
 *    optimal performance and the actual one.                              *
 ...
 *
 *
 *   Taken from multisat 1.9 (3c) and modified
 *
 ***************************************************************************/
