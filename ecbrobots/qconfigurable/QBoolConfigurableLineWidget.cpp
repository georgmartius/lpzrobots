...
namespace lpzrobots {
  ...
  QBoolConfigurableLineWidget::QBoolConfigurableLineWidget(QGridLayout* parentLayout, Configurable* config, Configurable::paramkey& key) : QAbstractConfigurableLineWidget(parentLayout, config, key) {
