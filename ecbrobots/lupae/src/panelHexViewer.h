...
/**
 * design pattern: view and model
 *
 * The hexViewer displays binary data in a human-readable manner. All the bytes
 * are presented as an hexadecimal number as well as and ascii-character. The
 * content of the buffer is displayed as lines of groups of 16 bytes. Every line
 * is subdevided into two parts. One displays the hexnumbers the other the
 * ascii-values.
 * An vertical scrollbar ables the user to change the shown pice of the data if
 * the amount of the buffer is too large to be displayed down completly.
 * Furthermore seperate pices of the hole buffer can be controlled and/or returned.
 */
